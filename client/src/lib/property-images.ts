...
export interface PropertyImage {
  ...
  alt: string;
  credit?: string;
  blurDataUrl?: string; // Low-quality placeholder for instant display
}

// Optimized CDN URLs with performance parameters:
// - fm=webp: Use WebP format for better compression (40-50% smaller than JPEG)
// - q=80: High quality but optimized (sweet spot for web)
// - w=1600: Optimized width for most screens (not over-fetching)
// - auto=format: Let browser choose best format (WebP/AVIF)
export const propertyImages: PropertyImage[] = [
  ...
  {
    url: "https://images.unsplash.com/photo-1558036117-15d82a90b9b1?auto=format&fit=crop&w=1600&q=80",
